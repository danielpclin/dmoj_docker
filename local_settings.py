...
EMAIL_HOST_USER = os.environ.get('EMAIL_USER', 'dmoj.epl@gmail.com')
...
SERVER_EMAIL = f"{os.environ.get('EMAIL_USER', 'dmoj.epl@gmail.com')}"
...
SITE_ADMIN_EMAIL = os.environ.get('EMAIL_USER', 'dmoj.epl@gmail.com')
...
SELECT2_JS_URL = '//select2.min.js'
SELECT2_CSS_URL = '//select2.min.css'
